// ============================================================
// ANÁLISIS — la vista ancha
// ============================================================
//
// La página única de la laptop: el muro de pagos del ciclo, el
// encabezado, la banda de trayectoria, la simulación de la primera
// pantalla, la ventana de opciones de pago y el cajón de calendario.
//
// Aquí vive el acomodo adaptativo del muro, que mide el espacio libre
// y decide columnas, escala y cuánto detalle mostrar. Es la parte más
// grande de la app y la que más crece.
//
// Depende de motor.js.
